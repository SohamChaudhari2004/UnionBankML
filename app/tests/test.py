...
story = """<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis'
    xmlns:mstts='http://www.w3.org/2001/mstts' xml:lang='en-US'>

    <voice name='en-US-JennyNeural'>
        <mstts:express-as style='sad'> There he was… Ethan, gasping for breath, knees trembling. 
        The finish line was still a mile away, but his body screamed for him to stop. </mstts:express-as>

        <mstts:express-as style='hopeful'> No! He couldn’t quit now. He had trained for months, waking up before sunrise, 
        running through pain, pushing past every doubt. </mstts:express-as>

        <mstts:express-as style='excited'> He looked ahead—people were cheering, his name echoed in the air. 
        'Come on, Ethan! You got this!' Something ignited inside him… </mstts:express-as>

        <mstts:express-as style='serious'> Each step felt heavier, his vision blurred, but he kept going. 
        His mother’s words rang in his head, ‘You are stronger than you think!’ </mstts:express-as>

        <mstts:express-as style='cheerful'> And then—he did it. The finish line! His feet crossed the tape, and a wave of victory surged through him. 
        He had conquered his doubts, his pain… his own limits. </mstts:express-as>

        <mstts:express-as style='hopeful'> Sometimes, the hardest mile is the one that defines you. Keep running. Keep believing. 
        Because victory belongs to those who refuse to stop. </mstts:express-as>
    </voice>
</speak>"""

async def speak_story():
    tts = edge_tts.Communicate(story, "en-US-JennyNeural")
    await tts.save("motivational_story.mp3")
    print("Audio saved as 'motivational_story.mp3' ✅")

# Check if running inside an event loop
if __name__ == "__main__":
    try:
        asyncio.run(speak_story())  # Normal script execution
    except RuntimeError:
        loop = asyncio.get_event_loop()
        loop.create_task(speak_story())  # Use create_task() in Jupyter Notebook
