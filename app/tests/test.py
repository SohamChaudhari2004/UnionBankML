...
#     def process_voice_input(self, audio_file_path=None):
#         """
#         Process voice input either from a file or microphone.
        
#         Args:
#             audio_file_path: Path to audio file, if None, uses microphone
...
#                 # Convert to wav for compatibility with recognizer
#                 with tempfile.NamedTemporaryFile(suffix=".wav", delete=False) as temp_wav:
#                     audio.export(temp_wav.name, format="wav")
#                     # Use Whisper for transcription
#                     result = self.whisper(temp_wav.name)
...
#                 transcribed_text = self.process_voice_input()
#                 if transcribed_text:
...
#     GROQ_API_KEY = os.environ.get("GROQ_API_KEY", "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")
